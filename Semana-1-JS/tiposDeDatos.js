// Tipos de datos: numericos
{
    ...
    let dinero = 10.10; // Tipo decimal (float o numbes con punto decimal)
    ...
    let resultado = null; // Valor nulo
    let noDefinido = undefined // Una variable que no se le ha asignado un valor
